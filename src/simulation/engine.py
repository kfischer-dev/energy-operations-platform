...
def simulate_power_of_asset(asset: SimulationAsset, context: SimulationContext, profile_data: dict[str, dict[str, int]]) -> float:
    ...
    if asset.asset_type == "solar_park":
        ...
        final_active_power_kw = asset.rated_power_kw * context.hydro_factor
    
    elif asset.asset_type == "biomass_power_plant":
        final_active_power_kw = asset.rated_power_kw * context.biomass_factor
